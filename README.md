...
- [My Twitter Clone](https://github.com/contimarta/Twitter-clone) - Full stack project: Twitter App clone using the MERN (MongoDB, Express, React, Node)  stack. Deployed with Render and Netlify [here](https://glittering-starship-2d6852.netlify.app/) (please be patient as it may take a few minutes to show tweets).
